...
pwd='inginf98'
try:    
    StrConnect='DRIVER={SQL Server};SERVER='+srvr+';DATABASE='+db+';UID='+username+';PWD='+pwd #Se establecen parametros de conexión
    #print(StrConnect)
...
try:    
     for index, row in df.iterrows(): #Recorre las lineas del csv
         try:        
             ...
             #Para este punto ya se limpiaron los datos
             ...
             print('Error loading data: {}' .format(ex))  #Control de excepciones
             #cursor.close()        
except Exception as ex:    
